...
class Colorizer(nn.Module):
    def __init__(self, in_channel=3, hidden_channel=3, out_channel=2,
        ...
        self.up_sample = nn.Sequential(
            ...
            nn.ConvTranspose2d(in_channels=24, out_channels=12,
                               kernel_size=3, stride=1, padding=1),
            nn.BatchNorm2d(12),
            nn.LeakyReLU(),
            ...
            nn.ConvTranspose2d(in_channels=6, out_channels=3,
                               kernel_size=3, stride=1, padding=1),
            nn.BatchNorm2d(3),
            nn.LeakyReLU(),

            nn.ConvTranspose2d(in_channels=3, out_channels=out_channel,
                               kernel_size=3, stride=1, padding=1)
        )
